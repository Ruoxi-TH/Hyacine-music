...
const dictionaries = {
  en: {
    ...
    adminStats: "STATISTICS", totalUsers: "Total users", adminUsers: "Admins", bannedUsers: "Banned",
    userManagement: "USER MANAGEMENT", ban: "Ban", unban: "Unban", promoteToAdmin: "Promote to admin", demoteToUser: "Demote to user",
    banReasonPlaceholder: "Enter ban reason (optional)", confirmBan: "Confirm ban", defaultBanReason: "Violation of community guidelines",
    confirmDeleteUser: "Delete user?", confirmDeleteUserHint: "This will permanently delete user {{username}} and all their data.",
    confirmRoleChange: "Change role to {{role}}?", adminError: "Error",
  ...
  "zh-CN": {
    ...
    adminStats: "统计", totalUsers: "总用户", adminUsers: "管理员", bannedUsers: "已封禁",
    userManagement: "用户管理", ban: "封禁", unban: "解封", promoteToAdmin: "设为管理员", demoteToUser: "设为普通用户",
    banReasonPlaceholder: "输入封禁原因（可选）", confirmBan: "确认封禁", defaultBanReason: "违反社区规范",
    confirmDeleteUser: "删除用户？", confirmDeleteUserHint: "将永久删除用户 {{username}} 及其所有数据。",
    confirmRoleChange: "确认将角色更改为 {{role}}？", adminError: "错误",
  ...
  ja: {
    ...
    adminStats: "統計", totalUsers: "総ユーザー", adminUsers: "管理者", bannedUsers: "凍結済み",
    userManagement: "ユーザー管理", ban: "凍結", unban: "凍結解除", promoteToAdmin: "管理者に昇格", demoteToUser: "一般ユーザーに降格",
    banReasonPlaceholder: "凍結理由を入力（任意）", confirmBan: "凍結を確認", defaultBanReason: "コミュニティガイドライン違反",
    confirmDeleteUser: "ユーザーを削除しますか？", confirmDeleteUserHint: "ユーザー {{username}} とそのデータが永久に削除されます。",
    confirmRoleChange: "ロールを {{role}} に変更しますか？", adminError: "エラー",
