...
const dictionaries = {
  en: {
    ...
    dailyRecommend: "Netease Cloud daily recommendations", dailySongs: "Daily songs", featuredBadge: "Featured for you", playRecommend: "▶ Play recommendations", nowPlayingShort: "Playing…", playFailed: "Playback failed", neteaseRequiredDaily: "Bind Netease Cloud Music to view daily recommendations.", neteaseDailyUnsupported: "This server does not provide Netease daily recommendations yet.", neteaseLoginExpired: "Netease login expired.", loadDailyFailed: "Could not load daily recommendations.", playPending: "Starting…",
  },
  "zh-CN": {
    ...
    dailyRecommend: "网易云每日推荐", dailySongs: "每日歌曲", featuredBadge: "为你推荐", playRecommend: "▶ 播放推荐歌曲", nowPlayingShort: "播放中…", playFailed: "播放失败", neteaseRequiredDaily: "绑定网易云音乐后可查看每日推荐。", neteaseDailyUnsupported: "当前服务器尚未提供网易云每日推荐。", neteaseLoginExpired: "网易云登录已失效。", loadDailyFailed: "无法加载每日推荐。", playPending: "正在播放…",
  },
  ja: {
    home: "ホーム", search: "検索", library: "ライブラリ", profile: "プロフィール",
    greeting: "こんばんは", subtitle: "音楽を、途切れさせない。", featured: "あなたへのおすすめ", playDemo: "デモ曲を再生", recentlyPlayed: "最近再生した曲",
    ...
    closePlayer: "プレーヤーを閉じる", nothingPlaying: "再生中の曲はありません", backToHome: "ホームへ戻る", nowPlaying: "再生中",
    ...
    dailyRecommend: "NetEase デイリーおすすめ", dailySongs: "デイリーソング", featuredBadge: "おすすめ", playRecommend: "▶ おすすめを再生", nowPlayingShort: "再生中…", playFailed: "再生に失敗しました", neteaseRequiredDaily: "NetEase Cloud Music を接続するとデイリーおすすめを表示できます。", neteaseDailyUnsupported: "このサーバーはまだ NetEase デイリーおすすめを提供していません。", neteaseLoginExpired: "NetEase のログイン期限が切れました。", loadDailyFailed: "デイリーおすすめを読み込めませんでした。", playPending: "再生準備中…",
  },
} as const;
